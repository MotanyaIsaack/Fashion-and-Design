...
<form action="<?=base_url();?>admin/addEvent" method="post">
    <div class="row">
        <div class="col-12">
            ...
            <div class="form-group row">
                <div class="col-5">
                    <label for="example-daterange1">Date Range</label>
                    <div class="input-daterange input-group" data-date-format="yyyy-mm-dd" data-week-start="1"
                        ...
                        <input value="<?=$row['date']?>" type="text" class="form-control form-control-lg"
                            id="example-daterange1" name="from" placeholder="From" data-week-start="1"
                            data-autoclose="true" data-today-highlight="true" readonly>
                    </div>
                </div>
                <div class="col-5">
