...
<html lang="en">
    <head>
        ...
        <!--  favicon -->
        <link rel="shortcut icon" href="<?=base_url();?>assets/website/assets/img/ico/favicon.png">
        <!--  apple-touch-icon -->
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-right">
                <ul class="topbar-cta no-margin">
                  <li class="mr-20">
                    <a><i class="material-icons mr-10">&#xE0B9;</i>info@kikoromeo.com</a>
                  </li>
                  <li>
                ...
                <div class="container">
                    ...
                    <div id="materialize-menu" class="menuzord">
                        ...
                        <ul class="menuzord-menu pull-right">
                            ...
                            <li class="active"><a href="javascript:void(0)">Portfolio</a>
                                <ul class="dropdown">
                                    ...
                                    <li class="active"><a href="#">Card Style</a>
                                        <ul class="dropdown">
                                            <li class="active"><a href="#">Card Boxed Style</a>
                                                <ul class="dropdown">
                                                    <li><a href="portfolio-card-4.html">4 Column</a></li>
                                                    <li class="active"><a href="portfolio-card-3.html">3 Column</a></li>
