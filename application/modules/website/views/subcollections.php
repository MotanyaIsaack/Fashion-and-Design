    ...
    <div class="container">
        ...
        <div class="portfolio-nav padding-top-100 padding-bottom-30">
            ...
            <div id="project-slider" class="carousel slide boot-slider" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img class="img-responsive" src="<?=base_url()?>assets/website/assets/Images/Image2.jpg" alt="">
                    </div>
                    <div class="item">
                        <img class="img-responsive" src="<?=base_url()?>assets/website/assets/Images/Image1.jpg" alt="">
                    </div>
                    <div class="item">
                        <img class="img-responsive" src="<?=base_url()?>assets/website/assets/Images/Image3.jpg" alt="">
                    </div>
                </div>
            ...
            <div class="project-overview padding-top-70 padding-bottom-100">
                <div class="row mb-80">
                    <div class="col-md-8">
                        ...
                        <p class="font-17">The SS 2015 Collection, an immersive exhibition dedicated
                            ...
                            the design is completely different each time. With 6000 square meters of
                            space at the West Bund Art Center, there is much room to play with this
                            time around. Click through for a look at the exhibit.</p>

                        <!-- <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit e Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p> -->
                    </div>
                ...
                <!-- <div class="client-testimonial text-center gray-bg">
                        <div class="avatar">
                            <img src="<?=base_url();?>assets/website/assets/img/quote-dark.png" alt="Customer Thumb">
                        </div>
                        <div class="content">
                            <p>Quam adipiscing vestibulum feugiat lacus leo a eget leo convallis sagittis nisi varius eros a imperdiet.Dui elementum ut a vestibulum eu fames hendrerit class conubia consequat curae dis lacinia luctus lacus ac cras dictumst elit nam euismod parturient consectetur scelerisque scelerisque maecenas.Interdum.</p>
