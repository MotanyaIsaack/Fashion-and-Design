...
INSERT INTO `event_collection_info` (`info_id`, `item_name`, `landing_img_id`, `item_info`, `item_summary`, `overview_header`, `overview_content`) VALUES
...
--
ALTER TABLE `event_collection_info`
  ADD CONSTRAINT `FK_image_info` FOREIGN KEY (`landing_img_id`) REFERENCES `image` (`img_id`);
COMMIT;
